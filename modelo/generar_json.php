...
<head>
  <meta charset="UTF-8">
  <title>Chatbot IXAH</title>
  <link rel="stylesheet" href="https://chatbot.giintapeinnovahue.com/css/styles.css">
...
<body>
  ...
  <div id="chatbot-toggle" class="chat-toggle-ixah" >
  <img src="https://chatbot.giintapeinnovahue.com/img/chatbot2.png" alt="Chat" class="toggle-icon-ixah">
  <span id="chatText" class="chat-text-ixah"></span>
  </div>
 
  <!-- Contenedor del Chatbot -->
  <div id="chatbot-container" class="chatbot-container-ixah" style="display: none;">

    <div class="chatbot-header-ixah">
      <img src="https://chatbot.giintapeinnovahue.com/img/gi.png" alt="Chatbot" class="chatbot-icon-ixah">
      <span class="chatbot-nombre"></span>
      <div class="conteiner-ixah">
        <div class="chatbot-min-ixah" title="Minimizar" onclick="toggleChatbot()">
          <svg class="icono-svg-ixah" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
            <path
        ...
        <div class="chatbot-close-ixah" title="Cerrar" onclick="cerrar()">
          <svg class="icono-svg-ixah" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
    ...
    <div class="chatbot-body-ixah">
      <div id="mensaje-inicial" class="chatbot-message-ixah">
        <p></p>
    ...
    <div id="user-input-container" class="user-input-container-ixah" style="display:none;">
  ...
  <div id="seleccion-estado-container" class="chatbot-message-ixah" style="display: none;">
  ...
  <div id="seleccion-alcaldia-container" class="chatbot-message-ixah" style="display: none;">
